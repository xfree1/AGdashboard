...
export const WEEKLY_PRODUCT_FILTER = {
  pevarozet_low: ['바로에젯', '피타큐젯', '피에젯타', '리바로젯 정 1/10mg', '스타젯 정 1/10mg', '엘제로젯 정 1/10mg', '페바로젯 저용량'],  // '리바로젯 정 1/10mg' 26년 6월 출시 반영, '엘제로젯 정 1/10mg' 26년 7월 출시 반영, '페바로젯 저용량'은 출시 후 데이터 자동 반영
